...
export default function Footer() {
  ...
  return (
    <footer className="!bg-white py-12 px-4 sm:px-6 lg:px-8 relative z-[100]">
      <div className="max-w-7xl mx-auto">
        <div className="!bg-white border-t border-[var(--color-brand-border)]/20 pt-24 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
            ...
            <div className="md:col-span-5">
              ...
              <div className="flex space-x-5 text-[var(--color-brand-body)]">
                ...
                <a href="https://github.com/annanyaa03/DRIPLENS-WEB" target="_blank" rel="noopener noreferrer" className="hover:text-black transition-colors">
